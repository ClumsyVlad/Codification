!(function (t, e) {
    ...
    return (function (t) {
        ...
        12: function (t, e, i) {
            ...
            class r extends s.b {
                static initClass() {
                    this.prototype.defaultOptions = { color: 0x0056AE, backgroundColor: 0xffffff, points: 10, maxDistance: 20, spacing: 15, showDots: !0 };
                }
                constructor(t) {
                    (n = t.THREE || n), super(t);
                }
                ...
                onInit() {
                    ...
                    (this.camera = new n.PerspectiveCamera(25, this.width / this.height, 0.01, 1e4)), this.camera.position.set(-100, 200, -100), this.scene.add(this.camera);
